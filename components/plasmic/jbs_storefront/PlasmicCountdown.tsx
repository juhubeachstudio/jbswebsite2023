...
import CountdownNumber from "../../CountdownNumber"; // plasmic-import: Tu3iaahTzpLP/component
...
function PlasmicCountdown__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__uVwR3)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__egX30)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__oBj6K)}
          number={
            <React.Fragment>
              {(() => {
                try {
        ...
        <CountdownNumber
          className={classNames("__wab_instance", sty.countdownNumber__egI45)}
          number={
            <React.Fragment>
              {(() => {
                try {
