...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 4zYX0j05aN3/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Gp2VtwSwUbo/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__mjlAe)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__azu8O)}
              />
            </React.Fragment>
          ),
          value: args.children
