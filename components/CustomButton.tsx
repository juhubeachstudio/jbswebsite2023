...
import {
  PlasmicCustomButton,
  DefaultCustomButtonProps
} from "./plasmic/jbs_storefront/PlasmicCustomButton";
...
// Omit to hide them:
//
// interface CustomButtonProps extends Omit<DefaultCustomButtonProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function CustomButton_(props: CustomButtonProps, ref: HTMLElementRefOf<"div">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicCustomButton are:
  ...
  return <PlasmicCustomButton root={{ ref }} {...props} />;
}
